(function(){
  ...
  document.getElementById('expenses-form__data').addEventListener('submit', function(e){
      ...
      document.getElementById('expenses-form__data').reset();
      showExpenses();
  });
  ...
  function createEmptyRow(){
      ...
      expenseTdTypeEl.textContent = 
          'Пока что список расходов пуст. Добавьте запись.';
  ...
  function createDataRow(expense){
      ...
      const deleteAnchorEl = document.createElement('td');
      ...
      deleteAnchorEl.innerHTML = '<button class="DeleteLineButton">Удалить</button>';
